        ...
        <section className="mt-4">
            ...
            <div className="shadow contact-intro px-3 pt-4 pb-2 position-relative">
                ...
                <ul className="list-inline text-center social-list-color">
                    ...
                    <li className="list-inline-item">
                        <a className="instagram" href="https://www.instagram.com/simonpangan/" target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
                    ...
                    <li className="list-inline-item">
                        <a className="linkedin" href="https://www.linkedin.com/in/simonpangan/" target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
